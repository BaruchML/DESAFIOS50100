...
export const generateToken = user => jwt.sign(user, jwt_secret_key,{expiresIn: '24h'}) //ESTAMOS HACIENDO LA MISMA FUCNION QUE SE COMENTA ABAJO, PERO DE UNA MANERA CON BUENAS PRACTICAS
