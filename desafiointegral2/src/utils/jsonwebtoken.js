...
export const generateToken = user => jwt.sign(user, this.PRIVATE_KEY,{expiresIn: '24h'}) //ESTAMOS HACIENDO LA MISMA FUCNION QUE SE COMENTA ABAJO, PERO DE UNA MANERA CON BUENAS PRACTICAS
